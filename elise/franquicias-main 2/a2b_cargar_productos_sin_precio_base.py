...
nombre_archivo = "5b..csv"
fila_inicial = 2
fila_final = 1000
cargar_seguimiento = True
cargar_fechas_caducidad = False
es_franquicia = False
es_multisucursal = True
cargar_minimos = False
cargar_almacen_inicial = False
listas_precios = ["Precio amigable", "Mayoreo", "XXXX", "YYYY"]
columnas_listas_precios = ["AC", "AD", "AE", "AF"]
...
format_list3.append(format.format("location_out_id", "many2one", util.col2num(
    "P"), "NoCreate", "stock.location", "name"))
