...
if(cargar_seguimiento):
    format_list.append(format.format("tracking", "selection", util.col2num("Q"), [("Serie","serial"), ("Lote","lot"), ("Sin seguimiento","none"), ("default", "none")],"", ""))
...
format_list.append(format.format("type", "selection", util.col2num("V"), [("Servicio", "service"),("Almacenable", "product"),("Consumible", "consu"),("default", "product")],"", ""))
format_list.append(format.format("clave_sat", "string", util.col2num("Z"), "", "", ""))
format_list.append(format.format("unidad_sat", "string", util.col2num("AA"), "", "", ""))

if(es_franquicia):
    format_list.append(format.format("garantia", "number", util.col2num("AB"), "options", "model", "compare"))
    format_list.append(format.format("comision", "number", util.col2num("AC"), "options", "model", "compare"))
    format_list.append(format.format("comision_especial", "number", util.col2num("AD"), "options", "model", "compare"))
...
format_list2.append(format.format("qty_multiple", "number", util.col2num("Y"), 1,"", ""))
...
format_list3.append(format.format("location_out_id", "many2one", util.col2num("AI"), "NoCreate", "stock.location", "name"))
